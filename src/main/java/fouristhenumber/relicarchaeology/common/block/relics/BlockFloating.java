package fouristhenumber.relicarchaeology.common.block.relics;
...
public class BlockFloating extends Block {
    ...
    public BlockFloating() {
        ...
        setBlockTextureName("relicarchaeology:floating_block");
    }
        ...
        public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
            if (!world.isRemote) {
                ...
                if (target == null || target.typeOfHit == MovingObjectPosition.MovingObjectType.MISS) {
                    // Raytrace the first empty block in player's line of sight
